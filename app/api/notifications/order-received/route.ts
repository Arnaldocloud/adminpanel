...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await service.notifyOrderReceived(playerName, playerPhone, orderId, amount, cartCount)
    ...
    console.error("Error in order-received notification:", error)
